/**
 * Specs Inc. 2026
 * Surface Detection component for the Path Pioneer Spectacles lens.
 */
...
export class SurfaceDetection extends BaseScriptComponent {
  @ui.label('<span style="color: #60A5FA;">SurfaceDetection – ground plane detector</span><br/><span style="color: #94A3B8; font-size: 11px;">Uses world hit testing to locate and confirm a stable horizontal surface.</span>')
  @ui.separator
  ...
  @input
  @allowUndefined
  @hint("Scene object moved to the detected surface position during calibration")
