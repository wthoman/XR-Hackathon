/**
 * Specs Inc. 2026
 * Defines Depth Cache, Color Camera Frame, Depth Color Pair for the BLE Playground lens.
 */
/*
...
export class DepthCache extends BaseScriptComponent {
  @ui.label('<span style="color: #60A5FA;">DepthCache – synchronized depth and color frame cache</span><br/><span style="color: #94A3B8; font-size: 11px;">Continuously captures color and depth frames and provides world-space position lookups from pixel coordinates.</span>')
  @ui.separator

  @ui.label('<span style="color: #60A5FA;">References</span>')
  @input
  @hint("Camera module used to request the left color camera stream")
