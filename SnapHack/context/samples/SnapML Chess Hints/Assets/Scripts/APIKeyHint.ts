/**
 * Specs Inc. 2026
 * APIKey Hint component for the SnapML Chess Hints Spectacles lens.
 */
import {
  AvaliableApiTypes,
...
export class APIKeyHint extends BaseScriptComponent {
  @ui.label('<span style="color: #60A5FA;">APIKeyHint – API key validation display</span><br/><span style="color: #94A3B8; font-size: 11px;">Shows a warning message when no valid API token is configured.</span>')
  @ui.separator
