/**
 * Specs Inc. 2026
 * MLController for the SnapML Chess Hints Spectacles lens experience.
 */
...
export class MLController extends BaseScriptComponent {
  @ui.label('<span style="color: #60A5FA;">MLController – YOLOv7 chess piece detection</span><br/><span style="color: #94A3B8; font-size: 11px;">Runs the ML model on camera frames and outputs chess piece detections.</span>')
  @ui.separator

  @ui.label('<span style="color: #60A5FA;">References</span>')
  @input()
  @hint("Camera service that provides the cropped input texture and frame callbacks")
  cameraService: CameraService

  @input()
  @hint("Chess board predictor that receives detection results each frame")
  chessBoardPredictor: ChessBoardPredictor

  @ui.separator
  @ui.label('<span style="color: #60A5FA;">Model Settings</span>')
  @input()
  @hint("ML model asset containing the YOLOv7 chess piece detector")
  model: MLAsset

  @input()
  @hint("Enable logging of model build and configuration info")
  modelInfo: boolean

  @input()
  @widget(new SliderWidget(0, 1, 0.01))
  @hint("Minimum confidence score for a detection to be considered valid")
