/**
 * Specs Inc. 2026
 * Randomize Board component for the SnapML Chess Hints Spectacles lens.
 */
...
export class RandomizeBoard extends BaseScriptComponent {
  @ui.label('<span style="color: #60A5FA;">RandomizeBoard – editor board randomization</span><br/><span style="color: #94A3B8; font-size: 11px;">Randomizes chess piece positions via random valid moves for editor testing.</span>')
  @ui.separator

  @ui.label('<span style="color: #60A5FA;">References</span>')
  @input()
  @hint("Chess board predictor used to reset the move state when randomizing")
  ...
  onAwake() {
    this.logger = new Logger("RandomizeBoard", this.enableLogging || this.enableLoggingLifecycle, true)
