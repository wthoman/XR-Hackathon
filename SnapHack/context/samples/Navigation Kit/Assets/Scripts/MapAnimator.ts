...
export class MapAnimator extends BaseScriptComponent {
  ...
  private start(): void {
    ...
    this.navigationComponent.onNavigationStarted.add((place) => {
      ...
      const userGeo = this.mapComponent.getCurrentLocationFocus() ?? this.userPosition.getGeoPosition()
      ...
      const midwayGeo = {longitude: halfLong, latitude: halfLat} as unknown as GeoPosition
