...
import {bindStartEvent, bindLateUpdateEvent} from "SnapDecorators.lspkg/decorators"
import {UICollisionSolver} from "../../Scripts/UICollisionDetector"
...
export class QuestMarkerController extends BaseScriptComponent {
  ...
  onAwake() {
    this.logger = new Logger("QuestMarkerController", this.enableLogging || this.enableLoggingLifecycle, true)
