/**
 * Specs Inc. 2026
 * Generic event system with typed event arguments. Provides a strongly-typed pub/sub mechanism
 * for component communication with automatic subscription management.
 */
