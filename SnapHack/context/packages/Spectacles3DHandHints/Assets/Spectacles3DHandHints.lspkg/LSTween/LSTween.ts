/**
 * Specs Inc. 2026
 * Main animation library providing high-level tween utilities for Lens Studio. Offers simplified
 * API for animating materials (alpha, color), text, transforms (position, rotation, scale), and
 * shader properties with automatic UpdateEvent management and chainable method calls.
 */
