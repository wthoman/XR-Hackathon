/**
 * Specs Inc. 2026
 * Tween group manager for organizing and batch-updating multiple tweens. Provides isolated tween
 * collections for large apps, automatic tween lifecycle management, batch update processing, and
 * add/remove operations for controlling animation groups independently.
 */
import now from './Now'
