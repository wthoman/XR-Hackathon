/**
 * Specs Inc. 2026
 * Advanced interpolation functions for smooth path animation between multiple keyframes. Supports
 * Linear interpolation for straight paths, Bezier curves for custom control points, and CatmullRom
 * splines for smooth curves through all points with automatic tangent calculation.
 */
