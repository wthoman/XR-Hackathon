/**
 * Specs Inc. 2026
 * Comprehensive easing functions library for smooth animation curves. Includes Linear, Quadratic,
 * Cubic, Quartic, Quintic, Sinusoidal, Exponential, Circular, Elastic, Back, and Bounce easing
 * with In, Out, and InOut variants, plus dynamic power curve generation for custom easing.
 */
