/**
 * Specs Inc. 2026
 * Core tween engine class for property animation with extensive customization. Handles value
 * interpolation, easing functions, repeat/yoyo modes, delays, chaining, and lifecycle callbacks
 * (onStart, onUpdate, onRepeat, onComplete, onStop) for creating complex animation sequences.
 *
 * Originally based on Tween.js - Licensed under the MIT license
