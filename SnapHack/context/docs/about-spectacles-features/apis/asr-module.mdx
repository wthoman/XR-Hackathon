---
description: 'Add speech-to-text to Spectacles Lenses using the ASR Module with 40+ language support, configurable accuracy modes, and mixed-language transcription.'
---
...
[AsrModule]: https://developers.snap.com/lens-studio/api/lens-scripting/classes/Built_In.AsrModule.html
