...
//float4 GradientColorA 4384
//float4 GradientColorB 4400
//float GradientPointA 4416
//float GradientPointB 4420
//float opacity 4424
//float Port_Input0_N086 4464
//float Port_Input1_N086 4468
//float Port_RangeMinA_N062 4472
//float Port_RangeMaxA_N062 4476
//float Port_RangeMinB_N062 4480
//float Port_RangeMaxB_N062 4484
//float2 Port_Import_N063 4488
//float2 Port_Center_N065 4496
//float Port_Value1_N009 4504
//float Port_Value1_N012 4520
//float Port_Input1_N083 4536
//float Port_Input2_N083 4540
//float depthRef 4544
//}
...
float GradientPointA;
float GradientPointB;
float opacity;
float4 Port_Import_N059;
float4 Port_Import_N060;
float Port_Input0_N086;
float Port_Input1_N086;
float Port_RangeMinA_N062;
float Port_RangeMaxA_N062;
float Port_RangeMinB_N062;
float Port_RangeMaxB_N062;
float2 Port_Import_N063;
float2 Port_Center_N065;
float Port_Value1_N009;
float2 Port_Import_N066;
float Port_Value1_N012;
...
float4 FinalColor=float4(1.0,1.0,1.0,0.25095001);
ssGlobals Globals;
...
float4 param_1=(*sc_set0.UserUniforms).GradientColorA;
Output_N10=param_1;
float4 Value_N59=float4(0.0);
Value_N59=Output_N10;
float4 Output_N13=float4(0.0);
float4 param_2=(*sc_set0.UserUniforms).GradientColorB;
Output_N13=param_2;
float4 Value_N60=float4(0.0);
Value_N60=Output_N13;
float2 UVCoord_N119=float2(0.0);
UVCoord_N119=Globals.Surface_UVCoord0;
float2 ValueOut_N62=float2(0.0);
ValueOut_N62=(((UVCoord_N119-float2((*sc_set0.UserUniforms).Port_RangeMinA_N062))/float2(((*sc_set0.UserUniforms).Port_RangeMaxA_N062-(*sc_set0.UserUniforms).Port_RangeMinA_N062)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N062-(*sc_set0.UserUniforms).Port_RangeMinB_N062))+float2((*sc_set0.UserUniforms).Port_RangeMinB_N062);
float2 Value_N63=float2(0.0);
Value_N63=(*sc_set0.UserUniforms).Port_Import_N063;
float2 CoordsOut_N65=float2(0.0);
CoordsOut_N65=((ValueOut_N62-(*sc_set0.UserUniforms).Port_Center_N065)*Value_N63)+(*sc_set0.UserUniforms).Port_Center_N065;
float Output_N8=0.0;
float param_3=(*sc_set0.UserUniforms).GradientPointA;
Output_N8=param_3;
float2 Value_N9=float2(0.0);
Value_N9.x=(*sc_set0.UserUniforms).Port_Value1_N009;
Value_N9.y=Output_N8;
float2 Value_N66=float2(0.0);
Value_N66=Value_N9;
float2 Output_N67=float2(0.0);
Output_N67=CoordsOut_N65-Value_N66;
float Output_N11=0.0;
float param_4=(*sc_set0.UserUniforms).GradientPointB;
Output_N11=param_4;
float2 Value_N12=float2(0.0);
Value_N12.x=(*sc_set0.UserUniforms).Port_Value1_N012;
Value_N12.y=Output_N11;
...
float Value3_N1=0.0;
float Value4_N1=0.0;
float4 param_5=Export_N88;
float param_6=param_5.x;
float param_7=param_5.y;
float param_8=param_5.z;
float param_9=param_5.w;
Value1_N1=param_6;
Value2_N1=param_7;
Value3_N1=param_8;
Value4_N1=param_9;
float3 Value_N24=float3(0.0);
Value_N24.x=Value1_N1;
Value_N24.y=Value2_N1;
Value_N24.z=Value3_N1;
float Output_N15=0.0;
float param_10=(*sc_set0.UserUniforms).opacity;
Output_N15=param_10;
float Output_N2=0.0;
Output_N2=Output_N15*Value4_N1;
float4 Value_N3=float4(0.0);
Value_N3=float4(Value_N24.x,Value_N24.y,Value_N24.z,Value_N3.w);
Value_N3.w=Output_N2;
FinalColor=Value_N3;
...
float4 l9_4=fast::max(param_12,float4(0.0));
float4 param_13=l9_4;
if (sc_ShaderCacheConstant_tmp!=0)
{
