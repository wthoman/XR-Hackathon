...
//float3x3 iconTransform 4576
//float4 iconUvMinMax 4624
//float4 iconBorderColor 4640
//float4 baseColor 4656
//float4 secondColor 4672
//float hasSecondColor 4688
//float Port_Input1_N017 4692
//float Port_Import_N062 4696
//float3 Port_Import_N068 4704
//float Port_Input1_N073 4720
//float Port_Input2_N073 4724
//float2 Port_Scale_N002 4728
//float2 Port_Center_N002 4736
//float2 Port_Input1_N000 4744
//float2 Port_Input0_N015 4752
//float Port_Input1_N027 4760
//float Port_Input1_N028 4764
//float3 Port_Normal_N010 4768
//float Port_Exponent_N010 4784
//float Port_Intensity_N010 4788
//float Port_Input1_N031 4792
//float4 Port_Input1_N023 4800
//float depthRef 4816
//}
...
float2 Port_Input0_N015;
float Port_Input1_N027;
float Port_Input1_N028;
float3 Port_Normal_N010;
float Port_Exponent_N010;
float Port_Intensity_N010;
float Port_Input1_N031;
float4 Port_Input1_N023;
float depthRef;
};
struct sc_Bone_t
{
...
l9_110=param_5.Surface_UVCoord1;
float2 l9_111=float2(0.0);
l9_111=((l9_110-(*sc_set0.UserUniforms).Port_Center_N002)*(*sc_set0.UserUniforms).Port_Scale_N002)+(*sc_set0.UserUniforms).Port_Center_N002;
...
int l9_118=l9_113;
int l9_119=iconLayout_tmp;
int l9_120=l9_118;
float2 l9_121=l9_111;
bool l9_122=(int(SC_USE_UV_TRANSFORM_icon_tmp)!=0);
float3x3 l9_123=(*sc_set0.UserUniforms).iconTransform;
int2 l9_124=int2(SC_SOFTWARE_WRAP_MODE_U_icon_tmp,SC_SOFTWARE_WRAP_MODE_V_icon_tmp);
bool l9_125=(int(SC_USE_UV_MIN_MAX_icon_tmp)!=0);
float4 l9_126=(*sc_set0.UserUniforms).iconUvMinMax;
bool l9_127=(int(SC_USE_CLAMP_TO_BORDER_icon_tmp)!=0);
float4 l9_128=(*sc_set0.UserUniforms).iconBorderColor;
float l9_129=0.0;
...
float4 l9_196=sc_set0.icon.sample(sc_set0.iconSmpSC,l9_195.xy,bias(l9_189));
...
l9_112=l9_198;
float l9_199=0.0;
float4 l9_200=l9_112;
float l9_201=l9_200.w;
l9_199=l9_201;
float2 l9_202=float2(0.0);
l9_202=step(l9_111,(*sc_set0.UserUniforms).Port_Input1_N000);
float l9_203=0.0;
float l9_204=0.0;
...
l9_208=step((*sc_set0.UserUniforms).Port_Input0_N015,l9_111);
float l9_209=0.0;
float l9_210=0.0;
...
l9_210=l9_213;
float l9_214=0.0;
l9_214=((l9_203+l9_204)+l9_209)+l9_210;
float l9_215=0.0;
l9_215=l9_199-l9_214;
float l9_216=0.0;
l9_216=fast::max(l9_215,(*sc_set0.UserUniforms).Port_Input1_N027);
float4 l9_217=float4(0.0);
l9_217=mix(l9_109,l9_112,float4(l9_216));
param_2=l9_217;
param_4=param_2;
}
else
{
float l9_218=0.0;
l9_218=(*sc_set0.UserUniforms).Port_Import_N062;
float3 l9_219=float3(0.0);
l9_219=param_5.VertexTangent_WorldSpace;
float3 l9_220=float3(0.0);
l9_220=param_5.VertexBinormal_WorldSpace;
float3 l9_221=float3(0.0);
l9_221=param_5.VertexNormal_WorldSpace;
float3x3 l9_222=float3x3(float3(0.0),float3(0.0),float3(0.0));
l9_222=float3x3(float3(l9_219),float3(l9_220),float3(l9_221));
float3 l9_223=float3(0.0);
l9_223=(*sc_set0.UserUniforms).Port_Import_N068;
...
int l9_233=l9_232;
l9_231=((*sc_set0.UserUniforms).sc_ViewMatrixArray[l9_233]*float4(l9_225,0.0)).xyz;
float3 l9_234=float3(0.0);
l9_234=(l9_231*float3((*sc_set0.UserUniforms).Port_Input1_N073))+float3((*sc_set0.UserUniforms).Port_Input2_N073);
...
int l9_241=l9_236;
int l9_242=additional_settings_btn_refl_texLayout_tmp;
int l9_243=l9_241;
float2 l9_244=l9_234.xy;
bool l9_245=(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex_tmp)!=0);
float3x3 l9_246=(*sc_set0.UserUniforms).additional_settings_btn_refl_texTransform;
int2 l9_247=int2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex_tmp,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex_tmp);
bool l9_248=(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex_tmp)!=0);
float4 l9_249=(*sc_set0.UserUniforms).additional_settings_btn_refl_texUvMinMax;
bool l9_250=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex_tmp)!=0);
float4 l9_251=(*sc_set0.UserUniforms).additional_settings_btn_refl_texBorderColor;
float l9_252=0.0;
...
float4 l9_319=sc_set0.additional_settings_btn_refl_tex.sample(sc_set0.additional_settings_btn_refl_texSmpSC,l9_318.xy,bias(l9_312));
...
Output_N28=Output_N1*float4((*sc_set0.UserUniforms).Port_Input1_N028);
float Rim_N10=0.0;
float3 param_7=(*sc_set0.UserUniforms).Port_Normal_N010;
float param_8=(*sc_set0.UserUniforms).Port_Exponent_N010;
float param_9=(*sc_set0.UserUniforms).Port_Intensity_N010;
ssGlobals param_11=Globals;
param_7=float3x3(float3(param_11.VertexTangent_WorldSpace),float3(param_11.VertexBinormal_WorldSpace),float3(param_11.VertexNormal_WorldSpace))*param_7;
float l9_324=abs(dot(-param_11.ViewDirWS,param_7));
float param_10=pow(1.0-l9_324,param_8);
param_10=fast::max(param_10,0.0);
param_10*=param_9;
Rim_N10=param_10;
float4 Output_N7=float4(0.0);
float4 param_12=(*sc_set0.UserUniforms).secondColor;
Output_N7=param_12;
float4 Output_N14=float4(0.0);
Output_N14=float4(Rim_N10)*Output_N7;
float Output_N8=0.0;
float param_13=(*sc_set0.UserUniforms).hasSecondColor;
Output_N8=param_13;
float4 Output_N9=float4(0.0);
Output_N9=Output_N14*float4(Output_N8);
float4 Output_N5=float4(0.0);
Output_N5=Output_N1+Output_N9;
float Output_N31=0.0;
Output_N31=Rim_N10*(*sc_set0.UserUniforms).Port_Input1_N031;
float4 Output_N18=float4(0.0);
Output_N18=mix(Output_N28,Output_N5,float4(Output_N31));
float4 Output_N23=float4(0.0);
Output_N23=fast::min(Output_N18,(*sc_set0.UserUniforms).Port_Input1_N023);
float4 Output_N3=float4(0.0);
Output_N3=Result_N16+Output_N23;
...
{
float4 l9_325=gl_FragCoord;
float2 l9_326=floor(mod(l9_325.xy,float2(4.0)));
float l9_327=(mod(dot(l9_326,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_14<l9_327)
{
discard_fragment();
}
...
float4 l9_328=fast::max(param_15,float4(0.0));
float4 param_16=l9_328;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_331=fast::clamp(l9_330.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_331=fast::clamp(dot(l9_330.xyz,float3(l9_330.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_331=(1.0-dot(l9_330.xyz,float3(0.33333001)))*l9_330.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_331=(1.0-fast::clamp(dot(l9_330.xyz,float3(1.0)),0.0,1.0))*l9_330.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_331=fast::clamp(dot(l9_330.xyz,float3(1.0)),0.0,1.0)*l9_330.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_331=fast::clamp(dot(l9_330.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_331=dot(l9_330.xyz,float3(0.33333001))*l9_330.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_331=1.0-fast::clamp(dot(l9_330.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_332=l9_331;
float l9_333=l9_332;
float l9_334=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_333;
float3 l9_335=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_329.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_336=float4(l9_335.x,l9_335.y,l9_335.z,l9_334);
param_17=l9_336;
}
else
{
...
{
float4 l9_337=param_17;
float4 l9_338=float4(0.0);
float4 l9_339=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_340=out.sc_FragData0;
l9_339=l9_340;
}
else
{
float4 l9_341=gl_FragCoord;
float2 l9_342=l9_341.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_347=l9_346;
int l9_348=l9_347;
float3 l9_349=float3(l9_343,0.0);
int l9_350=l9_345;
int l9_351=l9_348;
if (l9_350==1)
{
l9_349.y=((2.0*l9_349.y)+float(l9_351))-1.0;
}
float2 l9_352=l9_349.xy;
l9_344=l9_352;
}
else
{
...
int l9_365=sc_ScreenTextureLayout_tmp;
int l9_366=l9_363;
float l9_367=l9_357;
...
float4 l9_374=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_373.xy,bias(l9_367));
float4 l9_375=l9_374;
float4 l9_376=l9_375;
l9_339=l9_376;
}
float4 l9_377=l9_339;
float3 l9_378=l9_377.xyz;
float3 l9_379=l9_378;
float3 l9_380=l9_337.xyz;
float3 l9_381=definedBlend(l9_379,l9_380,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_338=float4(l9_381.x,l9_381.y,l9_381.z,l9_338.w);
float3 l9_382=mix(l9_378,l9_338.xyz,float3(l9_337.w));
l9_338=float4(l9_382.x,l9_382.y,l9_382.z,l9_338.w);
l9_338.w=1.0;
float4 l9_383=l9_338;
param_17=l9_383;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_384=float4(in.varScreenPos.xyz,1.0);
param_17=l9_384;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_385=gl_FragCoord;
float l9_386=fast::clamp(abs(l9_385.z),0.0,1.0);
float4 l9_387=float4(l9_386,1.0-l9_386,1.0,1.0);
param_17=l9_387;
}
else
{
float4 l9_388=param_17;
float4 l9_389=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_389=float4(mix(float3(1.0),l9_388.xyz,float3(l9_388.w)),l9_388.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_390=l9_388.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_390=fast::clamp(l9_390,0.0,1.0);
}
l9_389=float4(l9_388.xyz*l9_390,l9_390);
}
else
{
l9_389=l9_388;
...
float4 l9_395=param_19;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_395.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_395;
return out;
}
} // FRAGMENT SHADER
