...
//float2 size 4384
//float4 Port_Input0_N000 4400
//float Port_Input1_N003 4416
//float Port_Value2_N006 4420
//float Port_Value3_N006 4424
//float Port_radius_N007 4428
//float Port_borderSize_N007 4432
//float Port_borderSoftness_N007 4436
//float depthRef 4440
//}
...
float Port_radius_N007;
float Port_borderSize_N007;
...
Output_N3=UVCoord_N2*float2((*sc_set0.UserUniforms).Port_Input1_N003);
float2 Output_N5=float2(0.0);
Output_N5=Output_N3-float2(1.0);
float4 Value_N6=float4(0.0);
Value_N6=float4(Output_N5.x,Output_N5.y,Value_N6.z,Value_N6.w);
Value_N6.z=(*sc_set0.UserUniforms).Port_Value2_N006;
Value_N6.w=(*sc_set0.UserUniforms).Port_Value3_N006;
float2 Output_N1=float2(0.0);
float2 param_1=(*sc_set0.UserUniforms).size;
Output_N1=param_1;
float dist_N7=0.0;
float param_2=(*sc_set0.UserUniforms).Port_radius_N007;
float param_3=(*sc_set0.UserUniforms).Port_borderSize_N007;
float param_4=(*sc_set0.UserUniforms).Port_borderSoftness_N007;
float2 param_5=Output_N5;
float2 param_6=Output_N1;
float param_7=0.0;
N7_radius=param_2;
N7_borderSize=param_3;
N7_borderSoftness=param_4;
N7_position=param_5;
N7_scale=param_6;
float2 l9_1=N7_scale;
float2 l9_2=N7_position*(N7_scale+float2(2.0));
float2 l9_3=l9_2;
float2 l9_4=l9_1;
float l9_5=length(fast::max(((((abs(l9_3)-l9_4)+float2(N7_radius))+float2(N7_borderSize))-float2(2.0))+float2(N7_borderSoftness),float2(0.0)))-N7_radius;
N7_dist=l9_5;
float l9_6=1.0-smoothstep(0.0,N7_borderSoftness*2.0,N7_dist);
float l9_7=fast::clamp(l9_6,0.0,1.0);
N7_dist=l9_7;
param_7=N7_dist;
dist_N7=param_7;
float4 Output_N0=float4(0.0);
Output_N0=mix((*sc_set0.UserUniforms).Port_Input0_N000,Value_N6,float4(dist_N7));
...
float4 l9_11=fast::max(param_9,float4(0.0));
float4 param_10=l9_11;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
l9_21=float4(l9_64.x,l9_64.y,l9_64.z,l9_21.w);
float3 l9_65=mix(l9_61,l9_21.xyz,float3(l9_20.w));
l9_21=float4(l9_65.x,l9_65.y,l9_65.z,l9_21.w);
l9_21.w=1.0;
float4 l9_66=l9_21;
param_11=l9_66;
}
