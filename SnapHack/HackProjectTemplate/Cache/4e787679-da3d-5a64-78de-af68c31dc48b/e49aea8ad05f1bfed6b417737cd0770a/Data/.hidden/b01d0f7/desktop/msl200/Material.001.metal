...
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_1024=out.sc_FragData0;
l9_1023=l9_1024;
}
else
{
float4 l9_1025=gl_FragCoord;
float2 l9_1026=l9_1025.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
float2 l9_1027=l9_1026;
...
{
l9_1030=in.varStereoViewID;
}
int l9_1031=l9_1030;
int l9_1032=l9_1031;
float3 l9_1033=float3(l9_1027,0.0);
int l9_1034=l9_1029;
int l9_1035=l9_1032;
if (l9_1034==1)
{
l9_1033.y=((2.0*l9_1033.y)+float(l9_1035))-1.0;
}
float2 l9_1036=l9_1033.xy;
l9_1028=l9_1036;
}
else
{
...
float2 l9_1037=l9_1028;
float2 l9_1038=l9_1037;
...
{
l9_1045=in.varStereoViewID;
}
int l9_1046=l9_1045;
l9_1042=l9_1046;
}
int l9_1047=l9_1042;
float2 l9_1048=l9_1040;
int l9_1049=sc_ScreenTextureLayout_tmp;
int l9_1050=l9_1047;
float l9_1051=l9_1041;
float2 l9_1052=l9_1048;
int l9_1053=l9_1049;
int l9_1054=l9_1050;
float3 l9_1055=float3(0.0);
if (l9_1053==0)
{
l9_1055=float3(l9_1052,0.0);
}
else
{
if (l9_1053==1)
{
l9_1055=float3(l9_1052.x,(l9_1052.y*0.5)+(0.5-(float(l9_1054)*0.5)),0.0);
}
else
{
l9_1055=float3(l9_1052,float(l9_1054));
}
}
float3 l9_1056=l9_1055;
float3 l9_1057=l9_1056;
float4 l9_1058=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_1057.xy,bias(l9_1051));
float4 l9_1059=l9_1058;
float4 l9_1060=l9_1059;
l9_1023=l9_1060;
}
float4 l9_1061=l9_1023;
float3 l9_1062=l9_1061.xyz;
float3 l9_1063=l9_1062;
float3 l9_1064=l9_1021.xyz;
float3 l9_1065=definedBlend(l9_1063,l9_1064,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_1022=float4(l9_1065.x,l9_1065.y,l9_1065.z,l9_1022.w);
float3 l9_1066=mix(l9_1062,l9_1022.xyz,float3(l9_1021.w));
l9_1022=float4(l9_1066.x,l9_1066.y,l9_1066.z,l9_1022.w);
l9_1022.w=1.0;
float4 l9_1067=l9_1022;
param_58=l9_1067;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_1068=float4(in.varScreenPos.xyz,1.0);
param_58=l9_1068;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_1069=gl_FragCoord;
float l9_1070=fast::clamp(abs(l9_1069.z),0.0,1.0);
float4 l9_1071=float4(l9_1070,1.0-l9_1070,1.0,1.0);
param_58=l9_1071;
}
else
{
float4 l9_1072=param_58;
float4 l9_1073=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_1073=float4(mix(float3(1.0),l9_1072.xyz,float3(l9_1072.w)),l9_1072.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_1074=l9_1072.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_1074=fast::clamp(l9_1074,0.0,1.0);
}
l9_1073=float4(l9_1072.xyz*l9_1074,l9_1074);
}
else
{
l9_1073=l9_1072;
...
float4 l9_1079=param_60;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_1079.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_1079;
return out;
}
} // FRAGMENT SHADER
