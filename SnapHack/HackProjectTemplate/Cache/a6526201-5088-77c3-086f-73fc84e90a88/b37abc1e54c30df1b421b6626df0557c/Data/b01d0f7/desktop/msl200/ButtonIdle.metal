...
{
float4 l9_268=out.sc_FragData0;
l9_267=l9_268;
}
else
{
...
float4 l9_305=l9_267;
float3 l9_306=l9_305.xyz;
float3 l9_307=l9_306;
float3 l9_308=l9_265.xyz;
...
l9_266=float4(l9_309.x,l9_309.y,l9_309.z,l9_266.w);
float3 l9_310=mix(l9_306,l9_266.xyz,float3(l9_265.w));
l9_266=float4(l9_310.x,l9_310.y,l9_310.z,l9_266.w);
l9_266.w=1.0;
float4 l9_311=l9_266;
param_51=l9_311;
}
else
{
...
FinalColor=sc_OutputMotionVectorIfNeeded(param_52,in.varPosAndMotion,in.varNormalAndMotion);
float4 param_53=FinalColor;
float4 l9_323=param_53;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_323.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_323;
return out;
}
} // FRAGMENT SHADER
