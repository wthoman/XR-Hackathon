...
{
float4 l9_146=out.sc_FragData0;
l9_145=l9_146;
}
else
{
float4 l9_147=gl_FragCoord;
float2 l9_148=l9_147.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_153=l9_152;
int l9_154=l9_153;
float3 l9_155=float3(l9_149,0.0);
int l9_156=l9_151;
int l9_157=l9_154;
if (l9_156==1)
{
l9_155.y=((2.0*l9_155.y)+float(l9_157))-1.0;
}
float2 l9_158=l9_155.xy;
l9_150=l9_158;
}
else
{
...
float4 l9_180=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_179.xy,bias(l9_173));
float4 l9_181=l9_180;
float4 l9_182=l9_181;
l9_145=l9_182;
}
float4 l9_183=l9_145;
float3 l9_184=l9_183.xyz;
float3 l9_185=l9_184;
float3 l9_186=l9_143.xyz;
float3 l9_187=definedBlend(l9_185,l9_186,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_144=float4(l9_187.x,l9_187.y,l9_187.z,l9_144.w);
float3 l9_188=mix(l9_184,l9_144.xyz,float3(l9_143.w));
l9_144=float4(l9_188.x,l9_188.y,l9_188.z,l9_144.w);
l9_144.w=1.0;
float4 l9_189=l9_144;
param_8=l9_189;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_190=float4(in.varScreenPos.xyz,1.0);
param_8=l9_190;
}
else
{
...
float l9_192=fast::clamp(abs(l9_191.z),0.0,1.0);
float4 l9_193=float4(l9_192,1.0-l9_192,1.0,1.0);
param_8=l9_193;
}
else
{
float4 l9_194=param_8;
float4 l9_195=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_195=float4(mix(float3(1.0),l9_194.xyz,float3(l9_194.w)),l9_194.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_196=l9_194.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_196=fast::clamp(l9_196,0.0,1.0);
}
l9_195=float4(l9_194.xyz*l9_196,l9_196);
}
else
{
l9_195=l9_194;
...
float4 l9_201=param_10;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_201.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_201;
return out;
}
} // FRAGMENT SHADER
