...
export class TextInputFieldManager {
  ...
  public textInputFields: TextInputField[] = []
  public active: Set<TextInputField> = new Set()
  public recentlyClosed: boolean = false
   ...
   */
  public addField = (field: TextInputField) => {
  ...
  public isRegisteredTextFieldInteractable = (interactable: Interactable): boolean => {
   ...
   */
  public removeField = (field: TextInputField) => {
   ...
   */
  public registerActive = (field: TextInputField) => {
   ...
   */
  public deregisterActive = (field: TextInputField) => {
