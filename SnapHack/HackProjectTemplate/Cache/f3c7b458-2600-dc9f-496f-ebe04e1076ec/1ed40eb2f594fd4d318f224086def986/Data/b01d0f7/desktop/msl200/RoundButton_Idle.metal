...
int l9_119=l9_114;
float2 l9_120=l9_112;
int l9_121=sc_ScreenTextureLayout_tmp;
int l9_122=l9_119;
float l9_123=l9_113;
...
float4 l9_130=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_129.xy,bias(l9_123));
float4 l9_131=l9_130;
float4 l9_132=l9_131;
l9_95=l9_132;
}
float4 l9_133=l9_95;
float3 l9_134=l9_133.xyz;
float3 l9_135=l9_134;
float3 l9_136=l9_93.xyz;
float3 l9_137=definedBlend(l9_135,l9_136,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_94=float4(l9_137.x,l9_137.y,l9_137.z,l9_94.w);
float3 l9_138=mix(l9_134,l9_94.xyz,float3(l9_93.w));
...
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_140=float4(in.varScreenPos.xyz,1.0);
param_30=l9_140;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_141=gl_FragCoord;
float l9_142=fast::clamp(abs(l9_141.z),0.0,1.0);
float4 l9_143=float4(l9_142,1.0-l9_142,1.0,1.0);
param_30=l9_143;
}
else
{
float4 l9_144=param_30;
float4 l9_145=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_145=float4(mix(float3(1.0),l9_144.xyz,float3(l9_144.w)),l9_144.w);
}
else
{
...
l9_145=float4(l9_144.xyz*l9_146,l9_146);
}
else
{
l9_145=l9_144;
...
float4 l9_151=param_32;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_151.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_151;
return out;
}
} // FRAGMENT SHADER
