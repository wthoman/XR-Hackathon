...
{
float4 l9_399=out.sc_FragData0;
l9_398=l9_399;
}
else
{
...
int l9_422=l9_417;
float2 l9_423=l9_415;
int l9_424=sc_ScreenTextureLayout_tmp;
int l9_425=l9_422;
float l9_426=l9_416;
...
float4 l9_433=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_432.xy,bias(l9_426));
float4 l9_434=l9_433;
float4 l9_435=l9_434;
l9_398=l9_435;
}
float4 l9_436=l9_398;
float3 l9_437=l9_436.xyz;
float3 l9_438=l9_437;
float3 l9_439=l9_396.xyz;
float3 l9_440=definedBlend(l9_438,l9_439,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_397=float4(l9_440.x,l9_440.y,l9_440.z,l9_397.w);
float3 l9_441=mix(l9_437,l9_397.xyz,float3(l9_396.w));
l9_397=float4(l9_441.x,l9_441.y,l9_441.z,l9_397.w);
l9_397.w=1.0;
float4 l9_442=l9_397;
param_22=l9_442;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_443=float4(in.varScreenPos.xyz,1.0);
param_22=l9_443;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_444=gl_FragCoord;
float l9_445=fast::clamp(abs(l9_444.z),0.0,1.0);
float4 l9_446=float4(l9_445,1.0-l9_445,1.0,1.0);
param_22=l9_446;
}
else
{
float4 l9_447=param_22;
float4 l9_448=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_448=float4(mix(float3(1.0),l9_447.xyz,float3(l9_447.w)),l9_447.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_449=l9_447.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_449=fast::clamp(l9_449,0.0,1.0);
}
l9_448=float4(l9_447.xyz*l9_449,l9_449);
}
else
{
l9_448=l9_447;
