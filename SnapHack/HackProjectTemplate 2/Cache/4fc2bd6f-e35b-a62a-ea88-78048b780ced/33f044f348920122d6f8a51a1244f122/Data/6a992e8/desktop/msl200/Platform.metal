...
{
float4 l9_187=out.sc_FragData0;
l9_186=l9_187;
}
else
{
float4 l9_188=gl_FragCoord;
float2 l9_189=l9_188.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_194=l9_193;
int l9_195=l9_194;
float3 l9_196=float3(l9_190,0.0);
int l9_197=l9_192;
int l9_198=l9_195;
if (l9_197==1)
{
l9_196.y=((2.0*l9_196.y)+float(l9_198))-1.0;
}
float2 l9_199=l9_196.xy;
l9_191=l9_199;
}
else
{
...
int l9_212=sc_ScreenTextureLayout_tmp;
int l9_213=l9_210;
float l9_214=l9_204;
...
float4 l9_221=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_220.xy,bias(l9_214));
float4 l9_222=l9_221;
float4 l9_223=l9_222;
l9_186=l9_223;
}
float4 l9_224=l9_186;
float3 l9_225=l9_224.xyz;
float3 l9_226=l9_225;
float3 l9_227=l9_184.xyz;
...
l9_185=float4(l9_228.x,l9_228.y,l9_228.z,l9_185.w);
float3 l9_229=mix(l9_225,l9_185.xyz,float3(l9_184.w));
l9_185=float4(l9_229.x,l9_229.y,l9_229.z,l9_185.w);
l9_185.w=1.0;
float4 l9_230=l9_185;
param_48=l9_230;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_231=float4(in.varScreenPos.xyz,1.0);
param_48=l9_231;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_232=gl_FragCoord;
float l9_233=fast::clamp(abs(l9_232.z),0.0,1.0);
float4 l9_234=float4(l9_233,1.0-l9_233,1.0,1.0);
param_48=l9_234;
}
else
{
float4 l9_235=param_48;
float4 l9_236=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_236=float4(mix(float3(1.0),l9_235.xyz,float3(l9_235.w)),l9_235.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_237=l9_235.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_237=fast::clamp(l9_237,0.0,1.0);
}
l9_236=float4(l9_235.xyz*l9_237,l9_237);
}
else
{
l9_236=l9_235;
...
float4 l9_242=param_50;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_242.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_242;
return out;
}
} // FRAGMENT SHADER
