...
class CircleVisual {
    ...
    set handType(type) {
        ...
        switch (type) {
            case "left":
                materialInput = CircleVisualV2_1.CursorMaterialHandType.Left;
                break;
            case "right":
                materialInput = CircleVisualV2_1.CursorMaterialHandType.Right;
                break;
            default:
                materialInput = CircleVisualV2_1.CursorMaterialHandType.NonHand;
        }
