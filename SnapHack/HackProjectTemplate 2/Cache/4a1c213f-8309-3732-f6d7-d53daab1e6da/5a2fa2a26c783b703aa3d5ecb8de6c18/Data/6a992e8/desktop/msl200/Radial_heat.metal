...
{
float4 l9_121=out.sc_FragData0;
l9_120=l9_121;
}
else
{
...
float4 l9_155=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_154.xy,bias(l9_148));
float4 l9_156=l9_155;
float4 l9_157=l9_156;
l9_120=l9_157;
}
float4 l9_158=l9_120;
float3 l9_159=l9_158.xyz;
float3 l9_160=l9_159;
float3 l9_161=l9_118.xyz;
float3 l9_162=definedBlend(l9_160,l9_161,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_119=float4(l9_162.x,l9_162.y,l9_162.z,l9_119.w);
float3 l9_163=mix(l9_159,l9_119.xyz,float3(l9_118.w));
l9_119=float4(l9_163.x,l9_163.y,l9_163.z,l9_119.w);
l9_119.w=1.0;
float4 l9_164=l9_119;
param_29=l9_164;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_165=float4(in.varScreenPos.xyz,1.0);
param_29=l9_165;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_166=gl_FragCoord;
float l9_167=fast::clamp(abs(l9_166.z),0.0,1.0);
float4 l9_168=float4(l9_167,1.0-l9_167,1.0,1.0);
param_29=l9_168;
}
else
{
float4 l9_169=param_29;
