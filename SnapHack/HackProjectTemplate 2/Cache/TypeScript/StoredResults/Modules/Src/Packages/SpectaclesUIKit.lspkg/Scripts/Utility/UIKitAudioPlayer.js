...
exports.UIKitAudioPlayer = void 0;
const Singleton_1 = require("SpectaclesInteractionKit.lspkg/Decorators/Singleton");
let UIKitAudioPlayer = (() => {
    let _classDecorators = [Singleton_1.Singleton];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var UIKitAudioPlayer = _classThis = class {
        constructor() {
            this.inactiveAudioComponents = [];
        }
        play(audioTrack, volume) {
            const audioComponent = this.inactiveAudioComponents.length > 0 ? this.inactiveAudioComponents.shift() : this.createAudioComponent();
    ...
    __setFunctionName(_classThis, "UIKitAudioPlayer");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        UIKitAudioPlayer = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UIKitAudioPlayer = _classThis;
})();
exports.UIKitAudioPlayer = UIKitAudioPlayer;
//# sourceMappingURL=UIKitAudioPlayer.js.map