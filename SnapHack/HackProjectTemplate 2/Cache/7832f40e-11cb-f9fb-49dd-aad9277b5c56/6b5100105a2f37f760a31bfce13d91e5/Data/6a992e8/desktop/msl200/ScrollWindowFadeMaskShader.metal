...
//float radius 4384
//float softness 4388
//float2 windowSize 4392
//float3 Port_Value1_N001 4400
//float depthRef 4416
//}
...
Output_N3=param_1;
float Output_N5=0.0;
float param_2=(*sc_set0.UserUniforms).softness;
Output_N5=param_2;
float2 UVCoord_N0=float2(0.0);
UVCoord_N0=Globals.Surface_UVCoord0;
float2 Output_N2=float2(0.0);
float2 param_3=(*sc_set0.UserUniforms).windowSize;
Output_N2=param_3;
float dist_N104=0.0;
float param_4=Output_N3;
float param_5=Output_N5;
float2 param_6=UVCoord_N0;
float2 param_7=Output_N2;
float param_8=0.0;
N104_radius=param_4;
N104_borderSoftness=param_5;
N104_position=param_6;
N104_scale=param_7;
float2 l9_1=N104_scale*0.5;
float2 l9_2=(N104_position-float2(0.5))*2.0;
float2 l9_3=l9_1;
float l9_4=N104_radius;
l9_2=((abs(l9_2)*(l9_3+float2(l9_4)))-l9_3)+float2(N104_borderSoftness);
float l9_5=(length(fast::max(l9_2,float2(0.0)))+fast::min(fast::max(l9_2.x,l9_2.y),0.0))-l9_4;
N104_dist=l9_5;
float l9_6=smoothstep(0.0,N104_borderSoftness,N104_dist);
float l9_7=fast::clamp(l9_6,0.0,1.0);
N104_dist=l9_7;
param_8=N104_dist;
dist_N104=param_8;
float4 Value_N1=float4(0.0);
Value_N1=float4((*sc_set0.UserUniforms).Port_Value1_N001.x,(*sc_set0.UserUniforms).Port_Value1_N001.y,(*sc_set0.UserUniforms).Port_Value1_N001.z,Value_N1.w);
Value_N1.w=dist_N104;
FinalColor=Value_N1;
...
float4 l9_11=fast::max(param_10,float4(0.0));
float4 param_11=l9_11;
if (sc_ShaderCacheConstant_tmp!=0)
{
